##### Translates regular text into the glitch text effect #####
...
init python:
    ...
    # Picks a random character from the glitch alphabet to replace the original character for every character
    # in the input string.
